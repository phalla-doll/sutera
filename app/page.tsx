  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden bg-white text-black selection:bg-black selection:text-white">
      ...
      <div className="relative z-10 w-full h-screen flex flex-col justify-between p-6 pt-24 pb-12">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[500px] pointer-events-none flex items-center justify-center">
          
          {/* The Island Image */}
          <div className="relative w-[400px] h-[300px] z-20">
            <Image 
            ...
            />
            {/* Fake red flower */}
            <div className="absolute top-[-40px] left-1/2 -translate-x-1/2 w-12 h-12 bg-red-500 rounded-full blur-md opacity-80" />
            <div className="absolute top-[-30px] left-1/2 -translate-x-1/2 w-8 h-8 bg-red-600 rounded-full" />
            
            {/* Overlay squares on the image as seen in the design */}
            <div className="absolute top-1/4 left-1/2 w-16 h-16 border border-white/50 bg-white/10 backdrop-blur-sm" />
            <div className="absolute top-1/2 left-1/2 w-16 h-16 border border-white/50 bg-white/10 backdrop-blur-sm" />
            <div className="absolute top-1/2 left-[calc(50%+4rem)] w-16 h-16 border border-white/50 bg-white/10 backdrop-blur-sm" />
          </div>

          {/* Callout 1: Top Right */}
          <div className="absolute top-[10%] right-[10%] w-64">
            <div className="text-[9px] font-mono uppercase leading-tight mb-2">
            ...
            <svg className="absolute top-full left-0 w-[160px] h-[100px] overflow-visible" style={{ transform: 'translate(-100%, 0)' }}>
          ...
          {/* Callout 2: Left */}
          <div className="absolute top-[30%] -left-[10%] w-48 text-right">
            <div className="text-[9px] font-mono uppercase leading-tight mb-2">
              FROM DEEP ROOTS, CREATIVITY<br />
              DRAWS ITS STRENGTH
            </div>
            {/* Line connecting to left side */}
            <svg className="absolute top-full right-0 w-[160px] h-[80px] overflow-visible" style={{ transform: 'translate(100%, 0)' }}>
          ...
          <div className="absolute bottom-[10%] right-[20%] w-32">
            {/* Line connecting to bottom */}
            <svg className="absolute bottom-full left-0 w-[120px] h-[100px] overflow-visible" style={{ transform: 'translate(-100%, 0)' }}>
            ...
            <div className="text-[9px] font-mono uppercase leading-tight mt-2">
              FOUNDATION<br />
              DESIGNED FOR<br />
              GROWTH
            </div>
          ...
          <div className="absolute top-[40%] -right-[20%] w-64">
            {/* Line connecting to right side */}
            <svg className="absolute top-1/2 right-full w-[120px] h-[80px] overflow-visible" style={{ transform: 'translate(0, -50%)' }}>
            ...
            <div className="border border-black bg-white p-3 font-mono text-[10px] uppercase">
              <div className="flex justify-between items-center border-b border-black pb-2 mb-2 bg-black/5 p-1">
                <span className="font-bold text-sm">SUTÉRA</span>
        ...
        <div className="flex justify-between items-end w-full">
          ...
          <div className="w-64 font-mono text-[9px] uppercase">
